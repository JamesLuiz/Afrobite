        ...
        <div className="max-w-[1200px] mx-auto px-container-padding py-stack-lg flex flex-col gap-section-gap pb-24 md:pb-0">
            <section className="flex flex-col items-center justify-center gap-stack-md bg-surface-container-lowest p-stack-lg rounded-xl shadow-[0px_4px_20px_rgba(0,0,0,0.05)] border border-surface-variant">
                ...
                <div className="text-center">
                    ...
                    <p className="font-body-md text-body-md text-on-surface-variant">alex.johnson@example.com</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter">
                <section className="md:col-span-8 flex flex-col gap-stack-md">
                    ...
                    <div className="flex flex-col gap-stack-sm">
                        <div className="bg-surface-container-lowest p-container-padding rounded-xl shadow-sm border border-surface-variant flex flex-col sm:flex-row gap-gutter justify-between items-start sm:items-center">
                            <div className="flex gap-gutter items-center">
                                ...
                                <div className="flex flex-col">
                                    <h4 className="font-label-bold text-label-bold text-on-surface">Lagos Spice Kitchen</h4>
                                    <p className="font-label-sm text-label-sm text-on-surface-variant">Oct 24, 2023 • 2 Items</p>
                                    <p className="font-body-md text-body-md text-on-surface mt-1">Jollof Rice, Suya Skewers</p>
                                </div>
                            </div>
                            <div className="flex flex-col items-end gap-2 w-full sm:w-auto">
                                <span className="font-label-bold text-label-bold text-on-surface">£24.50</span>
                        ...
                        <div className="bg-surface-container-lowest p-container-padding rounded-xl shadow-sm border border-surface-variant flex flex-col sm:flex-row gap-gutter justify-between items-start sm:items-center">
                            <div className="flex gap-gutter items-center">
                                <div className="w-16 h-16 rounded-lg bg-surface-variant overflow-hidden flex-shrink-0">
                                    <img alt="Abyssinia Eats" className="w-full h-full object-cover" src="https://images.unsplash.com/photo-1634586450650-8446daaeabdb?w=200&q=80" />
                                </div>
                                <div className="flex flex-col">
                                    <h4 className="font-label-bold text-label-bold text-on-surface">Abyssinia Eats</h4>
                                    <p className="font-label-sm text-label-sm text-on-surface-variant">Oct 12, 2023 • 3 Items</p>
                                    <p className="font-body-md text-body-md text-on-surface mt-1">Veggie Combo, Doro Wat</p>
                                </div>
                            </div>
                            <div className="flex flex-col items-end gap-2 w-full sm:w-auto">
                                <span className="font-label-bold text-label-bold text-on-surface">£32.00</span>
                                <button className="w-full sm:w-auto bg-surface-container-highest text-primary font-label-bold text-label-bold px-4 py-2 rounded-lg hover:bg-surface-variant transition-colors active:scale-95">
                                    Reorder
                                </button>
                            </div>
                        </div>
                ...
                <section className="md:col-span-4 flex flex-col gap-stack-md">
                    ...
                    <Link to="/login" className="mt-stack-sm flex items-center justify-center gap-2 p-container-padding rounded-xl border border-error text-error hover:bg-error-container transition-colors active:scale-95 font-label-bold text-label-bold">
